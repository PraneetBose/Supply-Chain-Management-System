...
// We can reuse the CustomerDashboard we just built, moving it entirely into this route group
        ...
        return (
            <div className="flex items-center justify-center min-h-screen p-8 text-center text-zinc-400 bg-zinc-950">
                <div className="bg-zinc-900 border border-zinc-800 p-8 rounded-3xl max-w-md w-full shadow-2xl">
                    ...
                    <p className="mt-4 text-xs text-zinc-500">Clicking this will generate your unique 10-digit CustID and drop you into the dashboard.</p>
                </div>
            </div>
        )
    }
